<template>
    ...
    <div class=" mx-auto h-screen flex flex-col items-center justify-center gap-1" :class="{ 'text-white' : dark}">
        <video hidden id="videoInput" width="1200" height="900"></video>
        <div class="w-[360px] h-[360px] md:w-[400px] md:h-[400px] overflow-hidden flex justify-center items-center drop-shadow-xl">
          <canvas id="canvasOutput" width="640" height="480"></canvas>
        </div>
        <div class="w-[360px] md:w-full space-y-1">
